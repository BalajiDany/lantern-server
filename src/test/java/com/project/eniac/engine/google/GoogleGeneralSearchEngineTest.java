...
public class GoogleGeneralSearchEngineTest {
	...
	@Test
	void verifySearch() {
		SearchResultEntity<GeneralSearchResultEntity> entity = performSearch(SEARCH_QUERY);
		logResponse(entity);
	}

	private SearchResultEntity<GeneralSearchResultEntity> performSearch(String searchQuery) {
		...
		HttpGet request = googleGeneralSearchEngine.getRequest(searchEntity);
		...
		return googleGeneralSearchEngine.getResponse(response);
	}
