package com.project.lantern.engine;
...
public class EngineConstant {
    ...
    // Code
    public static final String ENGINE_STACK_OVERFLOW = "Stack Overflow · Google";
    ...
    // Video
    public static final String ENGINE_GOOGLE_VIDEO = "Youtube · Google";
